...
var sliderData;
var slides = ArrSlideComponents();
var limit = slides.length;
var shownSlideIndexes = [];
fetch("http://localhost:3000/slider").then(function (response) {
  ...
  function popupOnClick() {
    var _loop = function _loop(i) {
      slides[i].addEventListener("click", function () {
        var index = shownSlideIndexes[i];
        modal.style.display = "block";
        var modalInfo = document.createElement("div");
        modalContent.classList.add(".modal-info");
        var template = "\n        <img src=\"".concat(sliderData[index].background, "\" alt=\"Image\">\n        <h1>").concat(sliderData[index].title, "</h1>\n        <p>").concat(sliderData[index].subtitle, "</p>");
...
var slidesForScroll = document.querySelectorAll(".slide");
...
function showSlide(index) {
  ...
  slidesForScroll.forEach(function (slide) {
...
//news
var newsData;
var news = ArrNewsComponents();
var newsLimit = news.length;
var shownNewsIndexes = [];
fetch("http://localhost:3000/news").then(function (response) {
  return response.json();
}).then(function (data) {
  newsData = data;
  ...
  function popupOnClick() {
    var _loop2 = function _loop2(i) {
      news[i].addEventListener("click", function () {
        var index = shownNewsIndexes[i];
        modal.style.display = "block";
        var modalInfo = document.createElement("div");
        modalContent.classList.add(".modal-info");
        var template = "\n        <img src=\"".concat(newsData[index].image, "\" alt=\"Image\">\n        <h1>").concat(newsData[index].title, "</h1>\n        <p>").concat(newsData[index].subtitleFull, "</p>");
        modalInfo.innerHTML = template;
        modalContent.append(modalInfo);
      });
    };
